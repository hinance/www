...
instance Patchable Bank where
  patched banks = banks ++ [Bank {bid="virtual", baccs=[
    ...
    BankAcc {baid="walletj", balabel="Joe's wallet", babalance=1074000,
             bacurrency=USD, bacard=False, balimit=Nothing, bapaymin=Nothing,
             bapaytime=Nothing, batrans=[
      cashfrom 1430870400   9600,
      cashwdw  1428624000 142000,
      cashwdw  1427155200  88000,
      cashwdw  1423958400 112000,
      cashwdw  1421452800 100000,
      cashwdw  1412121600  74000,
      cashwdw  1400112000 150000,
      cashwdw  1394150400 168000,
      cashwdw  1378684800 190000,
      cashwdw  1361923200  26000,
      cashwdw  1359417600  22000,
